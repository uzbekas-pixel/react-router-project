...
const VideoLessonModal = ({ lesson, courseColor, onClose, onComplete, darkMode }) => {
  ...
  // Demo: 8 soniyadan keyin "ko'rib bo'lindi" deb hisoblaymiz
  useEffect(() => {
    let elapsed = 0;
  ...
  1: {
    ...
    sections: [
      { title: "Kirish", lessons: [
        ...
        { id:3, title:"Asosiy teglar", duration:"15 min", free:false, videoId:"qz0aGYrrlhU" },
      ]},
      { title: "Teglar va Atributlar", lessons: [
        { id:4, title:"Matn teglari", duration:"10 min", free:false, videoId:"qz0aGYrrlhU" },
        { id:5, title:"Havola va rasmlar", duration:"14 min", free:false, videoId:"UB1O30fR-EE" },
        { id:6, title:"Jadvallar", duration:"18 min", free:false, videoId:"qz0aGYrrlhU" },
      ]},
      { title: "Formalar", lessons: [
        { id:7, title:"Form elementlari", duration:"20 min", free:false, videoId:"UB1O30fR-EE" },
        { id:8, title:"Validatsiya", duration:"16 min", free:false, videoId:"qz0aGYrrlhU" },
      ]},
      { title: "HTML5 Yangiliklari", lessons: [
        { id:9, title:"Semantik teglar", duration:"12 min", free:false, videoId:"UB1O30fR-EE" },
        { id:10, title:"Audio va Video", duration:"15 min", free:false, videoId:"qz0aGYrrlhU" },
        { id:11, title:"Canvas asoslari", duration:"22 min", free:false, videoId:"UB1O30fR-EE" },
        { id:12, title:"Loyiha: Portfolio sahifa", duration:"30 min", free:false, videoId:"qz0aGYrrlhU" },
      ]},
    ],
  },
  2: {
    ...
    sections: [
      { title: "CSS Asoslari", lessons: [
        ...
        { id:2, title:"Selektorlar", duration:"14 min", free:true, videoId:"1Rs2ND1ryYc" },
        { id:3, title:"Box Model", duration:"18 min", free:false },
      ]},
      { title: "Flexbox", lessons: [
        { id:4, title:"Flex container", duration:"16 min", free:false },
        { id:5, title:"Flex items", duration:"14 min", free:false },
        { id:6, title:"Amaliy misol", duration:"20 min", free:false },
      ]},
      { title: "Grid Layout", lessons: [
        { id:7, title:"Grid asoslari", duration:"18 min", free:false },
        { id:8, title:"Grid areas", duration:"15 min", free:false },
        { id:9, title:"Responsive Grid", duration:"22 min", free:false },
      ]},
      { title: "Animatsiyalar", lessons: [
        { id:10, title:"Transition", duration:"12 min", free:false },
        { id:11, title:"@keyframes", duration:"16 min", free:false },
        { id:12, title:"Transform", duration:"14 min", free:false },
        { id:13, title:"Loyiha: Landing Page", duration:"35 min", free:false },
      ]},
    ],
  },
  3: {
    ...
    sections: [
      { title: "Asoslar", lessons: [
        ...
        { id:2, title:"O'zgaruvchilar: var, let, const", duration:"15 min", free:true, videoId:"PkZNo7MFNFg" },
        { id:3, title:"Ma'lumot turlari", duration:"18 min", free:false },
        { id:4, title:"Operatorlar", duration:"14 min", free:false },
      ]},
      { title: "Funksiyalar", lessons: [
        { id:5, title:"Funksiyalar asoslari", duration:"20 min", free:false },
        { id:6, title:"Arrow functions", duration:"16 min", free:false },
        { id:7, title:"Callback funksiyalar", duration:"22 min", free:false },
      ]},
      { title: "DOM va Events", lessons: [
        { id:8, title:"DOM nima?", duration:"18 min", free:false },
        { id:9, title:"Element tanlash", duration:"15 min", free:false },
        { id:10, title:"Event listeners", duration:"20 min", free:false },
        { id:11, title:"DOM o'zgartirish", duration:"18 min", free:false },
      ]},
      { title: "ES6+ Zamonaviy", lessons: [
        { id:12, title:"Destructuring", duration:"16 min", free:false },
        { id:13, title:"Spread & Rest", duration:"14 min", free:false },
        { id:14, title:"Promise va async/await", duration:"25 min", free:false },
        { id:15, title:"Fetch API", duration:"22 min", free:false },
      ]},
      { title: "Loyihalar", lessons: [
        { id:16, title:"To-Do App", duration:"30 min", free:false },
        { id:17, title:"Weather App", duration:"35 min", free:false },
        { id:18, title:"Quiz App", duration:"28 min", free:false },
      ]},
    ],
  },
  4: {
    ...
    sections: [
      { title: "React Asoslari", lessons: [
        ...
        { id:2, title:"Create React App / Vite", duration:"15 min", free:true, videoId:"bMknfKXIFA8" },
        { id:3, title:"JSX sintaksisi", duration:"18 min", free:false },
        { id:4, title:"Komponentlar", duration:"20 min", free:false },
      ]},
      { title: "Props va State", lessons: [
        { id:5, title:"Props tushunchasi", duration:"16 min", free:false },
        { id:6, title:"useState hook", duration:"20 min", free:false },
        { id:7, title:"State o'zgartirish", duration:"18 min", free:false },
      ]},
      { title: "Hooks", lessons: [
        { id:8, title:"useEffect", duration:"22 min", free:false },
        { id:9, title:"useRef va useMemo", duration:"18 min", free:false },
        { id:10, title:"Custom hooks", duration:"20 min", free:false },
      ]},
      { title: "React Router", lessons: [
        { id:11, title:"Routing asoslari", duration:"18 min", free:false },
        { id:12, title:"Dynamic routes", duration:"16 min", free:false },
        { id:13, title:"Protected routes", duration:"20 min", free:false },
      ]},
      { title: "Loyihalar", lessons: [
        { id:14, title:"Todo App", duration:"25 min", free:false },
        { id:15, title:"E-commerce UI", duration:"40 min", free:false },
        { id:16, title:"Dashboard", duration:"35 min", free:false },
      ]},
    ],
  },
  5: {
    ...
    sections: [
      { title: "A1 — Boshlang'ich", lessons: [
        ...
        { id:2, title:"Sonlar va alifbo", duration:"12 min", free:true, videoId:"3IqtmUscE_U" },
        { id:3, title:"To be fe'li", duration:"18 min", free:false },
        { id:4, title:"Uy-joy va oila", duration:"20 min", free:false },
      ]},
      { title: "A2 — Asosiy", lessons: [
        { id:5, title:"Simple Present", duration:"22 min", free:false },
        { id:6, title:"Simple Past", duration:"20 min", free:false },
        { id:7, title:"Kundalik suhbat", duration:"18 min", free:false },
        { id:8, title:"Oziq-ovqat va xarid", duration:"16 min", free:false },
      ]},
      { title: "B1 — O'rta", lessons: [
        { id:9, title:"Present Perfect", duration:"24 min", free:false },
        { id:10, title:"Modal fe'llar", duration:"20 min", free:false },
        { id:11, title:"Conditional sentences", duration:"22 min", free:false },
        { id:12, title:"Ish va kasb suhbati", duration:"25 min", free:false },
      ]},
      { title: "B2 — Yuqori O'rta", lessons: [
        { id:13, title:"Passive voice", duration:"20 min", free:false },
        { id:14, title:"Advanced vocabulary", duration:"22 min", free:false },
        { id:15, title:"IELTS Writing", duration:"30 min", free:false },
        { id:16, title:"IELTS Speaking", duration:"28 min", free:false },
      ]},
    ],
  },
  6: {
    ...
    sections: [
      { title: "Kirish", lessons: [
        ...
        { id:2, title:"Talaffuz qoidalari", duration:"18 min", free:true, videoId:"ex7XbNaEdAk" },
        { id:3, title:"Salomlashish iboralari", duration:"15 min", free:false },
      ]},
      { title: "Asosiy Grammatika", lessons: [
        { id:4, title:"Ot va sifatlar", duration:"22 min", free:false },
        { id:5, title:"Падежlar (6 ta)", duration:"30 min", free:false },
        { id:6, title:"Fe'llar va zamonlar", duration:"25 min", free:false },
        { id:7, title:"Son va sanoq", duration:"18 min", free:false },
      ]},
      { title: "Suhbat", lessons: [
        { id:8, title:"Tanishish va o'zini taqdim etish", duration:"20 min", free:false },
        { id:9, title:"Yo'l so'rash va tushuntirish", duration:"18 min", free:false },
        { id:10, title:"Do'kon va bozorda", duration:"16 min", free:false },
        { id:11, title:"Mehmonxona va restoran", duration:"20 min", free:false },
      ]},
      { title: "Biznes Rus Tili", lessons: [
        { id:12, title:"Ish muloqoti", duration:"25 min", free:false },
        { id:13, title:"Pochta va hujjatlar", duration:"22 min", free:false },
        { id:14, title:"TORFL tayyorgarligi", duration:"30 min", free:false },
      ]},
    ],
  },
  7: {
    ...
    sections: [
      { title: "Asoslar", lessons: [
        ...
        { id:2, title:"Salomlashish — Bonjour!", duration:"14 min", free:true, videoId:"KN_2RMkVGXA" },
        { id:3, title:"Sonlar 1-100", duration:"16 min", free:false },
        { id:4, title:"Ranglar va o'lchamlar", duration:"14 min", free:false },
      ]},
      { title: "Grammatika", lessons: [
        { id:5, title:"Artikl: le, la, les, un, une", duration:"20 min", free:false },
        { id:6, title:"Être va Avoir fe'llari", duration:"22 min", free:false },
        { id:7, title:"Présent tense", duration:"20 min", free:false },
        { id:8, title:"Sifatlar kelishigi", duration:"18 min", free:false },
      ]},
      { title: "Suhbat", lessons: [
        { id:9, title:"O'zini taqdim etish", duration:"18 min", free:false },
        { id:10, title:"Parijda yo'l so'rash", duration:"16 min", free:false },
        { id:11, title:"Restoranda buyurtma berish", duration:"18 min", free:false },
      ]},
      { title: "Fransuz Madaniyati", lessons: [
        { id:12, title:"Fransiya tarixi va madaniyati", duration:"20 min", free:false },
        { id:13, title:"Fransuz oshxonasi", duration:"16 min", free:false },
        { id:14, title:"Imtihon tayyorgarligi", duration:"30 min", free:false },
      ]},
    ],
  },
  8: {
    ...
    sections: [
      { title: "HTML5 Yangiliklari", lessons: [
        ...
        { id:2, title:"Doctype va meta teglar", duration:"10 min", free:true, videoId:"UB1O30fR-EE" },
        { id:3, title:"Semantik teglar: header, main, footer", duration:"15 min", free:false },
      ]},
      { title: "Semantik Tuzilma", lessons: [
        { id:4, title:"nav, article, section, aside", duration:"18 min", free:false },
        { id:5, title:"figure va figcaption", duration:"12 min", free:false },
        { id:6, title:"SEO uchun semantika", duration:"16 min", free:false },
      ]},
      { title: "Multimedia", lessons: [
        { id:7, title:"Video tegi", duration:"14 min", free:false },
        { id:8, title:"Audio tegi", duration:"12 min", free:false },
        { id:9, title:"Canvas asoslari", duration:"20 min", free:false },
        { id:10, title:"SVG grafikalar", duration:"18 min", free:false },
      ]},
    ],
  },
};
                      ...
                      {section.lessons.map(lesson=>{
                        ...
                        return (
                          <div key={lesson.id}
                            ...
                            style={{ display:"flex", alignItems:"center", gap:12, padding:"11px 16px", background:done?(darkMode?"#0f2818":"#f0fdf4"):(darkMode?"#0f172a":"#fff"), borderBottom:`1px solid ${darkMode?"#1e293b":"#f3f4f6"}`, cursor:locked?"default":"pointer", opacity:locked?0.6:1, transition:"background 0.15s" }}
                          ...
                          >
                            {/* Status icon */}
                            <div style={{ width:28, height:28, borderRadius:"50%", border:`2px solid ${done?"#10b981":locked?"#9ca3af":"#3b82f6"}`, background:done?"#10b981":"transparent", display:"flex", alignItems:"center", justifyContent:"center", fontSize:12, color:done?"#fff":locked?"#9ca3af":"#3b82f6", flexShrink:0, transition:"all 0.2s" }}>
                              {done ? "✓" : locked ? "🔒" : "▶"}
                            </div>
                            <div style={{ flex:1 }}>
